...
class Consumoscliente extends StatefulWidget {
  ...
  @override
  State<Consumoscliente> createState() => _ConsumosclienteState();
}

class _ConsumosclienteState extends State<Consumoscliente> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        return Obx(() {
          final consumos = clientController.Consumos;
          ...
          return SingleChildScrollView(
            child: Container(
              ...
              child:
              (consumos == null || consumos.isEmpty) ?
              Center(child: Text("No hay facturas registradas")) :


              Wrap(
                spacing: 15,
                runSpacing: 15,
                children: consumos.map<Widget>((consumo) {

                  final imagenes = consumo["imagenes"] ?? [];
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ✅ PROVEEDOR
                              Text(
                                "Proveedor: ${consumo["proveedor"] ?? "N/A"}",
                              ...
                              // ✅ CONSUMO
                              Text(
                                "Consumo: ${consumo["consumo"] ?? "N/A"} ${consumo["unidad"] ?? ""}",
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 5),
                                  Text(
                                    "${imagenes.length} ${imagenes.length == 1 ? "imágen" : "imágenes"}",
