...
import 'package:finanzas_verdes/views/admin/users/newTipoProveedor.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:google_fonts/google_fonts.dart';

class Moreadmin extends StatefulWidget{
  const Moreadmin({super.key});

  @override
  State<Moreadmin> createState() => _MoreadminState();
}

class _MoreadminState extends State<Moreadmin> {
  @override
