...
class Bottommenuproveedor extends StatefulWidget {
  const Bottommenuproveedor({super.key});

  @override
  State<Bottommenuproveedor> createState() => _BottommenuproveedorState();
}

class _BottommenuproveedorState extends State<Bottommenuproveedor> {
  final modules = [
    {"nombre" : "Inicio", "logo" : Icons.home_filled, "route" : ProveedorRoutes.home, "inPage" : [ProveedorRoutes.home]},
    ...
    {"nombre" : "Más", "logo" : Icons.menu, "route" : ProveedorRoutes.more, "inPage" : [ProveedorRoutes.more]},
  ];
  @override
