...
class Leftmenuproveedor extends StatefulWidget {
  const Leftmenuproveedor({super.key});

  @override
  State<Leftmenuproveedor> createState() => _LeftmenuproveedorState();
}

class _LeftmenuproveedorState extends State<Leftmenuproveedor> {
